...
const FuseSettingsForm = React.lazy(
  () => import('../components/forms/settings/FuseSettingsForm.jsx')
);
            ...
            <>
                ...
                <AccordionPanel>
                  <ErrorBoundary>
                    <Suspense fallback={<Loader />}>
                      <DvrSettingsForm active={accordianValue === 'dvr-settings'} />
                    </Suspense>
                  </ErrorBoundary>
                </AccordionPanel>
              </AccordionItem>
              ...
              <AccordionItem value="user-agents">
                ...
                <AccordionPanel>
                  <ErrorBoundary>
                    <Suspense fallback={<Loader />}>
                      <UserAgentsTable active={accordianValue === 'user-agents'} />
                    </Suspense>
                  </ErrorBoundary>
                </AccordionPanel>
              </AccordionItem>
              ...
              <AccordionItem value="network-access">
                ...
                <AccordionPanel>
                  <ErrorBoundary>
                    <Suspense fallback={<Loader />}>
                      <NetworkAccessForm active={accordianValue === 'network-access'} />
                    </Suspense>
                  </ErrorBoundary>
                </AccordionPanel>
              </AccordionItem>
              ...
              <AccordionItem value="proxy-settings">
                ...
                <AccordionPanel>
                  <ErrorBoundary>
                    <Suspense fallback={<Loader />}>
                      <ProxySettingsForm active={accordianValue === 'proxy-settings'} />
                    </Suspense>
                  </ErrorBoundary>
                </AccordionPanel>
              </AccordionItem>

              <AccordionItem value="fuse-settings">
                <AccordionControl>
                ...
                <AccordionPanel>
                  <ErrorBoundary>
                    <Suspense fallback={<Loader />}>
                      <FuseSettingsForm active={accordianValue === 'fuse-settings'} />
                    </Suspense>
                  </ErrorBoundary>
                </AccordionPanel>
              </AccordionItem>
