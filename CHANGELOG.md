...
- **Auto-sync at scale (FR #1196 implementation choices)**: the new override-aware sync flow is more capable than the prior path but the implementation choices below keep it viable on libraries with thousands of channels.
