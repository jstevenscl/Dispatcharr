...
- Sorting by Group and EPG columns in the Channels table, and sorting by Group in the Streams table. Column headers now display a sort icon and clicking them cycles through ascending/descending/unsorted states. (Closes #854) — Thanks [@CodeBormen](https://github.com/CodeBormen)
